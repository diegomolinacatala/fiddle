...
describe("acciones", () => {
  ...
  it("LISTA_ACCIONES expone las que el manager activa; las de la segunda cartilla y las del premio van solas", () => {
    expect(LISTA_ACCIONES.map((a) => a.key)).toEqual(["sellar", "restar", "canjear", "confirmar"]);
