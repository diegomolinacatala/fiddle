...
import { listClientes, listEventosDeNegocio, listCampanas, serialesRegistrados, getNegocio } from "@/lib/store";
import { perfilDe, metricas, conteoGrupos, cohortes, efectoCampana, LISTA_GRUPOS, LISTA_ESTADOS } from "@/lib/crm";
...
// Todo lo que pinta el panel del CRM, en UNA petición.
// GET /api/crm?b=<slug>
//
...
export async function GET(request) {
  ...
  try {
    ...
    // `instalado` es la fecha de alta en el Wallet, pero quien mande la verdad
    ...
    return NextResponse.json({
      negocio: { slug: negocio.slug, nombre: negocio.nombre, tipo: negocio.tipo, meta: negocio.meta, premio: negocio.premio, tema: negocio.tema },
